    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**").allowedOrigins("http://localhost:8080", "http://localhost:8991").allowCredentials(true).allowedHeaders("*").allowedMethods("*");
            }
        };
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/books/{id}").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/books/{id}").hasAuthority("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/authors/{id}").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/bookgenres/{id}").authenticated()
